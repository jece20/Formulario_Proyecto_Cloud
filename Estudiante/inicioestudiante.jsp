<!-- filepath: c:\xampp\tomcat\webapps\Proyectos de Grado\Estudiante\inicioestudiante.jsp -->
...
<div class="container mt-5">
    <div class="row justify-content-center g-4">
        <div class="col-md-4">
            <h1 class="text-center text-primary">Bienvenido, <%= nombreUsuario %>!</h1>
        ...
        <div class="col-md-4">
            <div class="card card-custom text-center">
                <div class="card-body">
                    ...
                    <a href="readestudiante.jsp" class="btn btn-green">Subir Ahora</a>
                </div>
            </div>
        </div>
    </div>
